...
pub trait ProbeEmitter {
    fn emit_core_probe(&self, symbol_table: &SymbolTable, probe: &CoreProbe) -> bool;
    fn emit_wasm_probe(&self, symbol_table: &SymbolTable, fn_probes: WasmFnProbes) -> bool;
    fn dump_to_file(&self) -> bool;
}
...
impl ProbeEmitter for WasmEmitter {
    fn emit_core_probe(&self, symbol_table: &SymbolTable, _probe: &CoreProbe) -> bool {
