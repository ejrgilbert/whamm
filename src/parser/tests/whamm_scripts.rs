...
/ {
    ...
    assert_eq!(10, ast.fns.len()); // strcmp, strcontains, mem, memcpy, mem_size, page_size, active_data_start, active_data_len, write_str, write_str
    ...
    assert_eq!(7, provider.def.bound_vars.len());
    ...
    assert_eq!(10, event.def.bound_vars.len());
