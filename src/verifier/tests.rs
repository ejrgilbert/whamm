...
/ {
    ...
    let num_scopes = 10;
    // records: num_scopes PLUS (str_addr, func_id, func_name, value, probe_id, fid, fname, pc, localN, target_imp_name, target_fn_name, target_fn_type, target_imp_module, imm0, arg[0:9]+, category_name, category_id)
    let num_recs = num_scopes + 16;
