...
use verifier_types::{SymbolTable};
use parser_types::{Dtrace};

use log::{error, trace};
use std::cell::RefCell;
use std::process::exit;
use crate::parser::types::DtraceVisitor;
...
pub fn verify(ast: &Dtrace) -> SymbolTable {
    ...
    // TODO -- the organization no longer makes sense...need to enter predicates to get the organization information though...
