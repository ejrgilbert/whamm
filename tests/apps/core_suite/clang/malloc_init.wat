(module
  ...
  (func $free_data (;7;) (type 6) (param i32)
  ...
  (func $free (;11;) (type 6) (param i32)
    local.get 0
    call $dlfree
  )
  (func $dlfree (;12;) (type 6) (param i32)
  ...
  (func $__wasi_fd_close (;13;) (type 2) (param i32) (result i32)
    local.get 0
    call $__imported_wasi_snapshot_preview1_fd_close
    i32.const 65535
    i32.and
  )
  (func $__wasi_fd_fdstat_get (;14;) (type 3) (param i32 i32) (result i32)
    local.get 0
    local.get 1
  ...
  (func $__wasi_fd_seek (;15;) (type 4) (param i32 i64 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $__wasi_fd_write (;16;) (type 5) (param i32 i32 i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
  ...
  (func $__wasi_proc_exit (;17;) (type 6) (param i32)
    local.get 0
    call $__imported_wasi_snapshot_preview1_proc_exit
    unreachable
  )
  (func $abort (;18;) (type 7)
    unreachable
    unreachable
  )
  (func $sbrk (;19;) (type 2) (param i32) (result i32)
    block ;; label = @1
      local.get 0
      br_if 0 (;@1;)
      memory.size
  ...
  (func $dummy (;20;) (type 7))
  (func $__wasm_call_dtors (;21;) (type 7)
    call $dummy
    call $__stdio_exit
  )
  (func $printf (;22;) (type 3) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $__stpcpy (;50;) (type 3) (param i32 i32) (result i32)
    (local i32 i32)
    block ;; label = @1
      block ;; label = @2
        block ;; label = @3
  ...
  (func $strcpy (;51;) (type 3) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $__stpcpy
    drop
  ...
  (func $strlen (;52;) (type 2) (param i32) (result i32)
    (local i32 i32)
    local.get 0
    local.set 1
    block ;; label = @1
  ...
  (func $memchr (;53;) (type 0) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    local.get 2
    i32.const 0
    i32.ne
  ...
  (func $strnlen (;54;) (type 3) (param i32 i32) (result i32)
    (local i32)
    local.get 0
    i32.const 0
    local.get 1
