wasm:opcode:call(arg0: f64, arg1: f32):before {
    ...
    eq_test4 = v32 as f32 == 0;
    report var eq_test5: bool;
    eq_test5 = v64 as f64 == 0;
    ...
    ne_test4 = v32 as f32 != 0;
    report var ne_test5: bool;
    ne_test5 = v64 as f64 != 0;
    ...
    ge_test4 = v32 as f32 >= 0;
    report var ge_test5: bool;
    ge_test5 = v64 as f64 >= 0;
    ...
    gt_test4 = v32 as f32 > 0;
    report var gt_test5: bool;
    gt_test5 = v64 as f64 > 0;
    ...
    le_test4 = v32 as f32 <= 0;
    report var le_test5: bool;
    le_test5 = v64 as f64 <= 0;
    ...
    lt_test4 = v32 as f32 < 0;
    report var lt_test5: bool;
    lt_test5 = v64 as f64 < 0;
    ...
    add_test4 = v32 as f32 + 0;
    report var add_test5: f64;
    add_test5 = v64 as f64 + 0;

    report var add_test8: f32;
    add_test8 = F32_MAX + v32;
    report var add_test9: f64;
    add_test9 = F64_MAX + v64;
    ...
    sub_test4 = v32 as f32 - 0;
    report var sub_test5: f64;
    sub_test5 = v64 as f64 - 0;

    report var sub_test8: f32;
    sub_test8 = F32_MIN - v32;
    report var sub_test9: f64;
    sub_test9 = F64_MIN - v64;
    ...
    mul_test4 = v32 as f32 * 0;
    report var mul_test5: f64;
    mul_test5 = v64 as f64 * 0;

    report var mul_test8: f32;
    mul_test8 = F32_MIN * v32;
    report var mul_test9: f64;
    mul_test9 = F64_MIN * v64;

    var TWO: f32 = (v32 + v32);
    report var mul_test10: f32;
    mul_test10 = F32_MIN * TWO;
    report var mul_test11: f64;
    mul_test11 = F64_MIN * TWO as f64;

    report var mul_test12: f32;
    mul_test12 = F32_MAX * v32;
    report var mul_test13: f64;
    mul_test13 = F64_MAX * v64;

    report var mul_test14: f32;
    mul_test14 = F32_MAX * TWO;
    report var mul_test15: f64;
    mul_test15 = F64_MAX * TWO as f64;
    ...
    div_test8 = F32_MIN / v32;
    report var div_test9: f64;
    div_test9 = F64_MIN / v64;
    ...
    mod_test8 = F32_MIN % v32;
    report var mod_test9: f64;
    mod_test9 = F64_MIN % v64;
