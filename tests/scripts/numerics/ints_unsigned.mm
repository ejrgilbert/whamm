wasm:opcode:call:before {
    ...
    mul_test20 = U8_MAX * 1;
    report u16 mul_test21;
    mul_test21 = U16_MAX * 1;
    report u32 mul_test22;
    mul_test22 = U32_MAX * 1;
    report u64 mul_test23;
    mul_test23 = U64_MAX * 1;
    
    report u8 mul_test24;
    mul_test24 = U8_MAX * 2;
    report u16 mul_test25;
    mul_test25 = U16_MAX * 2;
    report u32 mul_test26;
    mul_test26 = U32_MAX * 2;
    report u64 mul_test27;
    mul_test27 = U64_MAX * 2;
    ...
    div_test6 = v16 / (v32 as u8);
    report u16 div_test7;
    div_test7 = v16 / (v64 as u8);

    report u32 div_test8;
    div_test8 = v32 / (v8 as u32);
    report u32 div_test9;
    div_test9 = v32 / (v16 as u8);
    report u32 div_test10;
    div_test10 = v32 / v32;
    report u32 div_test11;
    div_test11 = v32 / (v64 as u8);

    report u64 div_test12;
    div_test12 = v64 / (v8 as u64);
    report u64 div_test13;
    div_test13 = v64 / (v16 as u8);
    report u64 div_test14;
    div_test14 = v64 / (v32 as u8);
    report u64 div_test15;
    div_test15 = v64 / v64;

    report u8 div_test16;
    div_test16 = 1 as u8 / 0 as u64;
    report u16 div_test17;
    div_test17 = 1 as u16 / 0 as u64;
    report u32 div_test18;
    div_test18 = 1 as u32 / 0 as u64;
    report u64 div_test19;
    div_test19 = 1 as u64 / 0 as u64;

    report u8 div_test20;
    div_test20 = U8_MIN / 1;
    report u16 div_test21;
    div_test21 = U16_MIN / 1;
    report u32 div_test22;
    div_test22 = U32_MIN / 1;
    report u64 div_test23;
    div_test23 = U64_MIN / 1;
    ...
    mod_test6 = v16 % (v32 as u8);
    report u16 mod_test7;
    mod_test7 = v16 % (v64 as u8);

    report u32 mod_test8;
    mod_test8 = v32 % (v8 as u32);
    report u32 mod_test9;
    mod_test9 = v32 % (v16 as u8);
    report u32 mod_test10;
    mod_test10 = v32 % v32;
    report u32 mod_test11;
    mod_test11 = v32 % (v64 as u8);

    report u64 mod_test12;
    mod_test12 = v64 % (v8 as u64);
    report u64 mod_test13;
    mod_test13 = v64 % (v16 as u8);
    report u64 mod_test14;
    mod_test14 = v64 % (v32 as u8);
    report u64 mod_test15;
    mod_test15 = v64 % v64;

    report u8 mod_test16;
    mod_test16 = 1 as u8 % 0 as u64;
    report u16 mod_test17;
    mod_test17 = 1 as u16 % 0 as u64;
    report u32 mod_test18;
    mod_test18 = 1 as u32 % 0 as u64;
    report u64 mod_test19;
    mod_test19 = 1 as u64 % 0 as u64;

    report u8 mod_test20;
    mod_test20 = U8_MIN % 1;
    report u16 mod_test21;
    mod_test21 = U16_MIN % 1;
    report u32 mod_test22;
    mod_test22 = U32_MIN % 1;
    report u64 mod_test23;
    mod_test23 = U64_MIN % 1;
    ...
    report u16 trunc_test0;
    trunc_test0 = U8_MAX as u16;
    report u32 trunc_test1;
    trunc_test1 = U16_MAX as u32;
    report u64 trunc_test2;
    trunc_test2 = U32_MAX as u64;
}