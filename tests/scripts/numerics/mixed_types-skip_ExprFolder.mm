wasm:opcode:call:before {
    ...
    trunc_test1 = (U8_MIN as i64) * (TWO as i64);
    ...
    ext_test2 = ((NEG as u8) as u16);
    report var ext_test3: u16;
    ext_test3 = ((NEG as i8) as u16);

    report var ext_test4: i32;
    ext_test4 = ((NEG as u8) as i32);
    report var ext_test5: i32;
    ext_test5 = ((NEG as i8) as i32);

    report var ext_test6: u32;
    ext_test6 = ((NEG as u8) as u32);
    report var ext_test7: u32;
    ext_test7 = ((NEG as i8) as u32);

    report var ext_test8: i64;
    ext_test8 = ((NEG as u8) as i64);
    report var ext_test9: i64;
    ext_test9 = ((NEG as i8) as i64);

    report var ext_test10: u64;
    ext_test10 = ((NEG as u8) as u64);
    report var ext_test11: u64;
    ext_test11 = ((NEG as i8) as u64);

    report var ext_test12: f32;
    ext_test12 = ((NEG as u8) as f32);
    report var ext_test13: f32;
    ext_test13 = ((NEG as i8) as f32);

    report var ext_test14: f64;
    ext_test14 = ((NEG as u8) as f64);
    report var ext_test15: f64;
    ext_test15 = ((NEG as i8) as f64);
}