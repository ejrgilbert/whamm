...
;; WHAMM --> var count: i32; wasm:opcode:call:before / target_fn_name == "dummy_five_params" / { if(true) { count = 3; } }
(assert_return (invoke "get_count") (i32.const 3))
;; WHAMM --> var count: i32; wasm:opcode:call:before / target_fn_name == "dummy_five_params" / { if(false) { count = 3; } }
(assert_return (invoke "get_count") (i32.const 0))

;; WHAMM --> var count: i32; wasm:opcode:call:before / target_fn_name == "dummy_five_params" / { var a: i32; if(a == 0) { count = 3; } }
(assert_return (invoke "get_count") (i32.const 3))
;; WHAMM --> var count: i32; wasm:opcode:call:before / target_fn_name == "dummy_five_params" / { var a: i32; if(a != 0) { count = 3; } }
(assert_return (invoke "get_count") (i32.const 0))
