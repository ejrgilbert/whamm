...
;; ----------------------
;; ==== unpredicated ====
;; WHAMM --> var count: i32; wasm:opcode:global_get:before { count++; }
...
;; WHAMM --> var count: i32; wasm:opcode:global_get:before /imm0 == 2/ { count++; }
...
;; WHAMM --> var count: i32; wasm:opcode:global_get:before /imm0 == 1/ { count++; }
(assert_return (invoke "get_count") (i32.const 4))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; WHAMM --> var count: i32; wasm:opcode:global_get:before /fid == 4 && pc == 5/ { count++; }
...
;; WHAMM --> var count: i32; wasm:opcode:global_get:before /fid == 4/ { count++; }
(assert_return (invoke "get_count") (i32.const 4))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; WHAMM --> var count: i32; wasm:opcode:global_get:before /fname == "start" && pc == 5/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; after mode
;; WHAMM --> var count: i32; wasm:opcode:global_get:after /fname == "start" && pc == 5/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; alt mode
;; WHAMM --> wasm:opcode:global_get:alt /fname == "start" && pc == 5/ { return 10; }
;; @passes_uninstr
