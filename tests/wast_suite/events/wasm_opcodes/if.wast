...
;; WHAMM --> i32 count; wasm:opcode:_if:entry /fid == 1 && pc == 1/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check
;; WHAMM --> i32 count; wasm:opcode:_if:entry /fid == 1 && pc == 0/ { count++; }
(assert_return (invoke "get_count") (i32.const 0)) ;; loc DNE
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check
;; WHAMM --> i32 count; wasm:opcode:_if:entry /fid == 1 && pc == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 0)) ;; loc DNE
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check
;; WHAMM --> i32 count; wasm:opcode:_if:entry /fname == "check" && pc == 1/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check

;; exit mode
;; WHAMM --> i32 count; wasm:opcode:_if:exit /fid == 1 && pc == 1/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check
;; WHAMM --> i32 count; wasm:opcode:_if:exit /fid == 2 && pc == 1/ { count++; }
(assert_return (invoke "get_count") (i32.const 0))
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check

;; after mode
;; WHAMM --> i32 count; wasm:opcode:_if:after /fid == 1 && pc == 1/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check
...
;;;; WHAMM --> wasm:opcode:_if:alt /fid == 1 && pc == 1/ { return 0; }
;;(assert_return (invoke "get_count") (i32.const 1))
;;;; @passes_uninstr
;;(assert_return (invoke "get_global_var") (i32.const 1)) ;; sanity check
