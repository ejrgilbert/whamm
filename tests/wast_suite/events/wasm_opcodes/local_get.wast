...
;; ----------------------
;; ==== unpredicated ====
;; WHAMM --> var count: i32; wasm:opcode:local_get:before { count++; }
...
;; WHAMM --> var count: i32; wasm:opcode:local_get:before /imm0 == 1/ { count++; }
...
;; WHAMM --> var count: i32; wasm:opcode:local_get:before /imm0 == 0/ { count++; }
(assert_return (invoke "get_count") (i32.const 8))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; WHAMM --> var count: i32; wasm:opcode:local_get:before /fid == 2 && pc == 2/ { count++; }
...
;; WHAMM --> var count: i32; wasm:opcode:local_get:before /fid == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; WHAMM --> var count: i32; wasm:opcode:local_get:before /fname == "basic_br" && pc == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; after mode
;; WHAMM --> var count: i32; wasm:opcode:local_get:after /fname == "basic_br" && pc == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; alt mode
;; WHAMM --> wasm:opcode:local_get:alt /fname == "basic_br" && pc == 2/ { return 1; }
