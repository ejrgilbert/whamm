...
;; ----------------------
;; ==== unpredicated ====
;; WHAMM --> i32 count; wasm:opcode:local_get:before { count++; }
...
;; WHAMM --> i32 count; wasm:opcode:local_get:before /imm0 == 1/ { count++; }
...
;; WHAMM --> i32 count; wasm:opcode:local_get:before /imm0 == 0/ { count++; }
(assert_return (invoke "get_count") (i32.const 8))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; WHAMM --> i32 count; wasm:opcode:local_get:before /fid == 2 && pc == 2/ { count++; }
...
;; WHAMM --> i32 count; wasm:opcode:local_get:before /fid == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; WHAMM --> i32 count; wasm:opcode:local_get:before /fname == "basic_br" && pc == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
...
;; after mode
;; WHAMM --> i32 count; wasm:opcode:local_get:after /fname == "basic_br" && pc == 2/ { count++; }
(assert_return (invoke "get_count") (i32.const 1))
;; @passes_uninstr
(assert_return (invoke "get_global_var0") (i32.const 0)) ;; sanity check
;; @passes_uninstr
