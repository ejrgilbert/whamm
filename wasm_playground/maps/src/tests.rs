...
fn test_i32_i32() {
    ...
    println!("{:?}", get_i32_optional("test".to_string(), &1));
    let a = get_i32_optional("test".to_string(), &1);
    println!("{:?}", get_i32_optional("test".to_string(), &a.unwrap()));
    assert!(a == Some(2));
}
#[test]
fn test_string_bool() {
    ...
    println!("{:?}", get_bool_optional("test".to_string(), &"hello".to_string()));
    let a = get_bool_optional("test".to_string(), &"hello".to_string());
    println!("{:?}", get_bool_optional("test".to_string(), &a.unwrap()));
    assert!(a == Some(true));
}
...
fn test_i32_tuple() {
    ...
    println!("{:?}", get_tuple_optional("test".to_string(), &1));
    let a = get_tuple_optional("test".to_string(), &1);
...
fn test_i32_map() {
    ...
    let mut map = get_map_optional("test".to_string(), &1).unwrap();
    ...
    println!("{:?}", get_map_optional("test".to_string(), &1).unwrap().get_i32(&2));
    assert!(get_map_optional("test".to_string(), &1).unwrap().get_i32(&2) == Some(3));
    assert!(get_map_optional("test".to_string(), &1).unwrap().get_i32(&3) == None);
}
//tuple as key
#[test]
fn test_tuple_i32() {
    ...
    println!(
        "{:?}",
        get_i32_optional("test".to_string(), &Box::new(TupleVariant::i32_i32(1, 2)))
    );
    let a = get_i32_optional("test".to_string(), &Box::new(TupleVariant::i32_i32(1, 2)));
    assert!(a == Some(3));
}
...
fn test_i32_i32_notopt() {
    ...
    println!("{:?}", get_i32("test".to_string(), &a));
    assert!(a == 2);
}
